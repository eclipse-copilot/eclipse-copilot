...
package org.eclipse.copilot.ui.terminal.legacy;
...
/**
 * Legacy terminal tool implementation for older Eclipse versions.
 */
public class RunInTerminalTool implements IRunInTerminalTool {
  ...
  private ITerminalControl getTerminalControl(String terminalTitle, boolean isBackground) {
    ...
    // Use Display.asyncExec instead of SwtUtils.invokeOnDisplayThread
    Display.getDefault().asyncExec(() -> {
      try {
        ...
        //TODO: Handle PartInitException properly
      } catch (Exception e) {
        //TODO: Handle any other exceptions properly
      }
    });
